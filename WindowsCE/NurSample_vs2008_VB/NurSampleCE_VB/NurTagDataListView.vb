...
'NurApi wrapper
Partial Public Class NurTagDataListView
    ...
    Public Class TagItem
        ...
        Public Sub New(ByVal tag As NurApi.Tag)
            Me.Tag = tag
            Me.TagViewItem = New ListViewItem(New String() {tag.rssi.ToString(), tag.GetEpcString(), If(tag.irData IsNot Nothing, NurApi.BinToHexString(tag.irData), "-")})
    ...
    ''' <summary>
    ''' Initializes a new instance of the <see cref="NurTagDataListView"/> class.
    ''' </summary>
    Public Sub New()
        InitializeComponent()
    End Sub
    ...
    Public Function UpdateTagList(ByVal inventoriedTags As NurApi.TagStorage) As Integer
    ...
    Private Sub tagListView_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
