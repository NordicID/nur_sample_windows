...
Partial Public Class Settings
    ...
    Private Sub FillNurComboBox(ByVal comboBox As ComboBox, ByVal setupFlag As Integer, ByVal minValue As Integer, ByVal maxValue As Integer, ByVal clear As Boolean)
        ' Fill ComboBox
    ...
    Private Sub SelectNurComboBox(ByVal comboBox As ComboBox, ByVal value As Integer)
    ...
    Private Function GetNurComboBoxValue(ByVal comboBox As ComboBox) As Integer
        Dim item As ComboItem = TryCast(comboBox.SelectedItem, ComboItem)
        Return item.value
    End Function

    Private Sub UpdateAntennaControls(ByVal antennaMask As Integer, ByVal antennaSelection As Integer)
    ...
    Private Sub SettingsChanged(ByVal sender As Object, ByVal e As EventArgs)
    ...
    Private Sub GetSettingsFromControls()
        Try
            ...
            newSetup.readRssiFilter.min = CSByte(readRssiMin.Value)
            newSetup.readRssiFilter.max = CSByte(readRssiMax.Value)
            newSetup.writeRssiFilter.min = CSByte(writeRssiMin.Value)
            newSetup.writeRssiFilter.max = CSByte(writeRssiMax.Value)
            newSetup.inventoryRssiFilter.min = CSByte(inventoryRssiMin.Value)
            newSetup.inventoryRssiFilter.max = CSByte(inventoryRssiMax.Value)
    ...
    Private Sub storeSetupBtn_Click(ByVal sender As Object, ByVal e As EventArgs)
