...
{
    public class BINCOUNTER : BINARRAY
    {
		/// <summary>
		...
		public BINCOUNTER(RT0005Tag tag)
            : base(tag)
        {
            mBaseAddress = RTRegs.BIN_COUNTER_BASE;
			mExceptionMsg = "BIN: invalid counter index.";
        }

        /// <summary>
        /// Indexing of the BIN counters.
        /// </summary>
