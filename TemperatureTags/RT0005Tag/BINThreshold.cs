...
{
    public class BINTHRESHOLD : BINARRAY
    {
		/// <summary>
		...
		public BINTHRESHOLD(RT0005Tag tag)
            : base(tag)
        {
            mBaseAddress = RTRegs.BIN_THRESHOLD_BASE;
			mExceptionMsg = "BIN: invalid threshold index.";
        }

		/// <summary>
		/// Indexing of the BIN thresholds.
		/// </summary>
