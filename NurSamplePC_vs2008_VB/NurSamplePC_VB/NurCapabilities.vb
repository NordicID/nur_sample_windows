...
Public NotInheritable Class NurCapabilities
	...
	Public Structure NurCapabilityItem
		...
		Public Overrides Function ToString() As String
			Return Text
		End Function
		Public Sub New(setupFlag__1 As Integer, value__2 As Integer, text__3 As String)
	...
	Public Function ConvertToString(setupFlag As Integer, value As Integer) As String
		Select Case setupFlag
			...
			Case NurApi.SETUP_TXLEVEL
				...
				Else
					...
					Dim mW As Integer = CInt(Math.Truncate(Math.Round(Math.Pow(10, CDbl(dBm) / 10))))
