...
Public Partial Class Writer
	...
	''' <param name="sender">The source of the event.</param>
	''' <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
	Private Sub writeTagListView_SelectedTagChanged(sender As Object, e As EventArgs)
	...
	''' <param name="sender">The source of the event.</param>
	''' <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
	Private Sub pickUpButton_Click(sender As Object, e As EventArgs)
		Try
			Dim usedTxLevel As Integer
			Dim strongestTag As NurApi.Tag
	...
	Private Sub SetTargetTag(bank As Byte, start As UInteger, mask As Byte())
	...
	''' <param name="sender">The source of the event.</param>
	''' <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
	Private Sub writeNewEpcBtn_Click(sender As Object, e As EventArgs)
		...
		Try
			...
			Dim sAddress As UInteger = CUInt(Math.Truncate(targetStartUD.Value))
			Dim sMaskBitLength As Integer = CInt(Math.Truncate(targetLengthUD.Value))
	...
	''' <param name="sender">The source of the event.</param>
	''' <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
	Private Sub readMemButton_Click(sender As Object, e As EventArgs)
		Dim message As String = "Mem read successfully!"
		Dim startTick As Integer = System.Environment.TickCount
		Dim icon As MessageBoxIcon = MessageBoxIcon.None
		Try
			...
			Dim rdAddress As UInteger = CUInt(Math.Truncate(memStartUD.Value))
			Dim rdByteCount As Byte = CByte(Math.Truncate(memLengthUD.Value))
			Dim data As Byte() = hNur.ReadSingulatedTag(passwd, secured, sBank, sAddress, sMaskBitLength, sMask, _
	...
	''' Invalid parameter
	''' </exception>
	Private Sub writeMemButton_Click(sender As Object, e As EventArgs)
		...
		Try
			...
			Dim wrAddress As UInteger = CUInt(Math.Truncate(memStartUD.Value))
	...
	''' <param name="sender">The source of the event.</param>
	''' <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
	Private Sub setLockStateButton_Click(sender As Object, e As EventArgs)
	...
	''' <param name="sender">The source of the event.</param>
	''' <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
	Private Sub readPasswordButton_Click(sender As Object, e As EventArgs)
	...
	''' <param name="sender">The source of the event.</param>
	''' <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
	Private Sub writePasswordButton_Click(sender As Object, e As EventArgs)
	...
	''' <param name="sender">The source of the event.</param>
	''' <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
	Private Sub killButton_Click(sender As Object, e As EventArgs)
